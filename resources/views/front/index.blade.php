    ...
    <div id="fullpage">
        <div class="section home-page active">
            ...
            <div class="content" id="scene" data-relative-input="true">
                <div class="welcome-text" data-depth="0.5">
        ...
        <div class="section">
            ...
            @foreach($portfolios as $portfolio)
                <div class="slide js-tilt p-4">
                    <div class="portfolio-description">
                        <div class="row overlay">
                            <div class="col-md-11">
                                <h1 class="font-size-2-5 font-weight-bold portfolio-name">{{ $portfolio->name }}</h1>
                                <a href="{{ $portfolio->link }}" target="_blank">{{ $portfolio->link }}</a>
                                <p class="mt-5 text-justify portfolio-desc">
                                ...
                                <div class="technologies">
                                    <div class="tasks">
                                        ...
                                        <i class="{{ $attribute->icon }}" data-toggle="tooltip" data-placement="bottom"
                                           title="{{ $attribute->description }}" aria-hidden="true"></i>
                                    </span>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1 portfolio-logo">
                                <img src="{{ (!empty($portfolio->file)) ? asset($portfolio->file->name) : '' }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="skill col-md-2">
                                <div class="skill-item">
                                    <div class="skill-logo">
                                        <img src="{{ (!empty($skill->file)) ? asset($skill->file->name) : '' }}"
                                             class="skill-tiny-logo" alt="">
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="socials">
                            <a href="https://github.com/mojtabaRKS" class="social-item"><i class="fa fa-github"
                                                                                           aria-hidden="true"></i></a>
                            <a href="#" class="social-item"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                            <a href="https://www.linkedin.com/in/mojtaba-rakhisi-4125b6a8/" class="social-item"><i
                                        class="fa fa-linkedin" aria-hidden="true"></i></a>
                            <a href="https://t.me/mojtabarks" class="social-item"><i class="fa fa-telegram"
                                                                                     aria-hidden="true"></i></a>
                            <a href="https://mojtabarakhisi.slack.com" class="social-item"><i class="fa fa-slack"
                                                                                              aria-hidden="true"></i></a>
                            <a href="https://stackoverflow.com/users/7551147/mojtaba-rakhisi" class="social-item"><i
                                        class="fa fa-stack-overflow" aria-hidden="true"></i></a>
                            <a href="https://www.instagram.com/mojtaba.rks/" class="social-item"><i
